...
(response is generated eventually), partition tolerance as the ability to work when there may be a network
...
cases when there are network partitions. 
   ...
   * In synchronous models, Theorem 1 still holds, as CAP is mainly influenced by the presence
